...
var i_33143 = (0);
while(true){
if((i_33143 < arr.length)){
(arr[i_33143] = null);

var G__33145 = (i_33143 + (1));
i_33143 = G__33145;
continue;
} else {
}
...
var i_33161 = (self__.level + (1));
while(true){
if((i_33161 <= (new_level + (1)))){
(update[i_33161] = self__.header);

var G__33162 = (i_33161 + (1));
i_33161 = G__33162;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_33163 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_33163[i]));
} else {
x__$2.forward.push((((i < links_33163.length))?(links_33163[i]):null));
}

if((i < links_33163.length)){
(links_33163[i] = x__$2);
} else {
links_33163.push(x__$2);
}
...
var i_33166 = (0);
while(true){
if((i_33166 <= self__.level)){
var links_33170 = (update[i_33166]).forward;
if((x__$1 === (((i_33166 < links_33170.length))?(links_33170[i_33166]):null))){
(links_33170[i_33166] = (x__$1.forward[i_33166]));

var G__33176 = (i_33166 + (1));
i_33166 = G__33176;
continue;
} else {
var G__33177 = (i_33166 + (1));
i_33166 = G__33177;
continue;
}
} else {
...
var G__33187 = nx;
var G__33188 = (level__$1 - (1));
x = G__33187;
level__$1 = G__33188;
continue;
} else {
var G__33189 = x;
var G__33190 = (level__$1 - (1));
x = G__33189;
level__$1 = G__33190;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__33192 = nx;
var G__33193 = (level__$1 - (1));
x = G__33192;
level__$1 = G__33193;
continue;
} else {
var G__33194 = x;
var G__33195 = (level__$1 - (1));
x = G__33194;
level__$1 = G__33195;
continue;
}
