...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33821 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_33821(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_33826 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_33826(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_33827 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_33827(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_33829 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_33829(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33836 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_33836(runtime,input,callback);
}
});
...
shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__33818,callback){
var map__33819 = p__33818;
var map__33819__$1 = cljs.core.__destructure_map(map__33819);
var input = map__33819__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33819__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33819__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
