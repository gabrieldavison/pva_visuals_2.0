...
return window.osc((60),0.005).mult(window.osc((70),0.01)).contrast(1.5).blend(window.src(hclj.set2.o0)).blend(window.src(hclj.set2.o0)).blend(window.src(hclj.set2.o0)).out();
}));

hclj.midi.set_button((1),(function (){
return window.osc((60),0.05).mult(window.osc((100),0.01)).contrast((2)).blend(window.src(hclj.set2.o0)).blend(window.src(hclj.set2.o0)).blend(window.src(hclj.set2.o0)).blend(window.src(hclj.set2.o0)).out();
}));

hclj.midi.set_button((2),(function (){
return window.osc((60),0.5).mult(window.osc((70),0.01)).contrast((5)).blend(window.src(hclj.set2.o0)).blend(window.src(hclj.set2.o0)).out();
}));

hclj.midi.set_button((3),(function (){
return window.osc((80),(1)).mult(window.osc((70),0.01)).contrast((5)).out();
}));

return hclj.midi.set_button((4),(function (){
return window.osc((20),(1)).add(window.osc((7),0.01)).contrast((5)).out();
}));
});
...
})).scale(1.01).blend(hclj.set2.o0).contrast((2)).out(hclj.set2.o0);
}));
...
return hclj.set2.get_fft((0),di_mult);
})).modulate(window.src(hclj.set2.o0).colorama((10)),0.1).scale(1.01).blend(hclj.set2.o0).out(hclj.set2.o0);
}));

return hclj.midi.set_button((3),(function (){
return window.osc((20),0.02,0.9).color((1),0.4,(1)).kaleid([(4),(8),(3),(6)]).rotate((0),0.7).modulate(hclj.set2.o0,(function (){
return hclj.set2.get_fft((0),di_mult);
})).modulate(window.voronoi((100)),0.5).scale(1.01).blend(hclj.set2.o0).out(hclj.set2.o0);
}));
});
...
})).modulate(hclj.set2.o0,0.01).contrast((2)).out();
}));

hclj.midi.set_button((1),(function (){
return window.src(hclj.set2.o3).contrast(1.2).modulate(window.noise((1000)),(function (){
return hclj.set2.get_fft((0),pb_mult);
})).modulate(hclj.set2.o0,0.1).contrast((2)).invert().out();
}));

hclj.midi.set_button((2),(function (){
return window.src(hclj.set2.o3).contrast(1.2).modulate(window.noise((1000)),(function (){
return hclj.set2.get_fft((0),pb_mult);
})).modulate(hclj.set2.o0,0.1).contrast((2)).diff(window.src(hclj.set2.o3).invert()).out();
}));

hclj.midi.set_button((3),(function (){
return window.src(hclj.set2.o3).contrast(1.2).modulate(window.noise((1000)),(function (){
return hclj.set2.get_fft((0),pb_mult);
})).modulate(hclj.set2.o0,0.5).diff(window.noise((100)).pixelate((1))).contrast((2)).out();
}));

hclj.midi.set_button((4),(function (){
return window.src(hclj.set2.o3).contrast(1.2).modulate(window.noise((1000)),(function (){
return hclj.set2.get_fft((0),pb_mult);
})).modulate(hclj.set2.o0,0.5).diff(window.noise((100)).pixelate((1))).contrast((2)).blend(window.osc((50),0.5).contrast((2)).pixelate((1),(1))).contrast((2)).out();
}));

hclj.midi.set_button((5),(function (){
return window.src(hclj.set2.o3).contrast(1.8).diff(window.noise((10)).pixelate((1)).modulate(hclj.set2.o0,0.5)).out();
}));

hclj.midi.set_button((6),(function (){
return window.src(hclj.set2.o3).contrast(1.8).diff(window.noise((10)).pixelate((1)).modulate(hclj.set2.o0,0.5)).invert().out();
}));

return hclj.midi.set_button((7),(function (){
return window.src(hclj.set2.o3).contrast(1.8).diff(window.noise((10)).pixelate((1)).modulate(hclj.set2.o0,0.5)).invert().modulate(window.src(hclj.set2.o3)).out();
}));
});
...
hclj.midi.set_button((1),(function (){
return window.osc((10),0.15,0.3).add(window.osc((4),0.2,0.8)).modulate(window.noise((10))).mult(window.noise([(1),(5),(2)].fast((2))).pixelate((50),(50))).modulate(hclj.set2.o0,0.5).saturate((2)).out();
}));
...
hclj.midi.set_button((0),(function (){
return window.osc((10),(3),(0)).contrast((2)).out();
}));

hclj.midi.set_button((1),(function (){
return window.osc((10),(10),(0)).contrast((2)).modulate(window.src(hclj.set2.o3)).invert().out();
}));

hclj.midi.set_button((2),(function (){
return window.osc((10),(10),(0)).contrast((2)).invert().modulate(window.src(hclj.set2.o3)).diff(hclj.set2.o0).contrast((2)).out();
}));

return hclj.midi.set_button((3),(function (){
return window.osc((3),(50),(0)).contrast((2)).invert().modulate(window.src(hclj.set2.o3)).diff(hclj.set2.o0).contrast((2)).out();
}));
});
...
hclj.midi.set_button((0),(function (){
return window.osc((10),0.1).modulate(window.noise((6)),0.2).diff(window.src(hclj.set2.o0)).modulateScrollY(window.osc((2)).modulate(window.osc().rotate(),0.11)).scale(0.9).contrast(1.5).out();
}));

hclj.midi.set_button((1),(function (){
return window.osc((10),0.1).modulate(window.noise((function (){
return hclj.set2.get_fft((0),(20));
})),0.2).diff(window.src(hclj.set2.o0)).modulateScrollY(window.osc((2)).modulate(window.osc().rotate(),0.11)).scale(0.9).contrast(1.5).out();
}));
...
hclj.midi.set_button((3),(function (){
return window.osc((10),0.1,0.4).modulate(window.noise((6)),0.2).diff(window.src(hclj.set2.o0)).modulateScrollY(window.osc((2)).modulate(window.osc().rotate(),0.11)).scale(1.2).contrast(1.5).modulate(hclj.set2.o0,0.01).scale((1)).out();
}));

hclj.midi.set_button((4),(function (){
return window.osc((10),0.1,0.4).modulate(window.noise((6)),0.2).diff(window.src(hclj.set2.o0)).modulateScrollY(window.osc((2)).modulate(window.osc().rotate(),0.11)).scale(1.2).contrast(1.5).modulate(hclj.set2.o0,0.001).modulate(window.voronoi((10)).pixelate([(5),(10),(20)],[(15),(30),(2)]).contrast((2)),0.2).out();
}));

hclj.midi.set_button((5),(function (){
return window.osc((10),0.1,0.4).modulate(window.noise((6)),0.2).diff(window.src(hclj.set2.o0)).modulateScrollY(window.osc((2)).modulate(window.osc().rotate(),0.11)).scale(1.2).contrast(1.5).modulate(hclj.set2.o0,0.001).modulate(window.voronoi((10)).pixelate([(5),(10),(20),(80),(1)].fast((10)),[(15),(30),(2),(1)].fast((7))).contrast((2)),0.2).out();
}));
...
})),0.3).add(hclj.set2.o0).out(hclj.set2.o0);
}));
});
...
return hclj.set2.talks();
}));
hclj.kb.set_k((4),(function (){
return hclj.set2.comfort_eating();
}));
...
hclj.kb.set_k((7),(function (){
return hclj.set2.sleek_form();
}));
hclj.kb.set_k((8),(function (){
